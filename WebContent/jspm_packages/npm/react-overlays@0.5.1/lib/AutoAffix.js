...
var AutoAffix = (function(_React$Component) {
  ...
  AutoAffix.prototype.render = function render() {
    ...
    return _react2['default'].createElement('div', null, _react2['default'].createElement('div', {ref: 'positioner'}), _react2['default'].createElement(_Affix2['default'], _extends({
...
AutoAffix.defaultProps = {autoWidth: true};
