  ...
  !function(e) {
    function t(e, t) {
      ...
      if (e instanceof Error) {
        var r = new Error(e.message, e.fileName, e.lineNumber);
        v ? (r.message = e.message + "\n	" + t, r.stack = e.stack) : (r.message = e.message, r.stack = e.stack + "\n	" + t);
      } else
        r = e + "\n	" + t;
      return r;
    }
    function r(e, r, n) {
      try {
        new Function(e).call(n);
      } catch (a) {
        throw t(a, "Evaluating " + r);
      }
    }
    function n() {}
    function a(t) {
    ...
    function d(e, t) {
      ...
      for (var o in e) {
        ...
        if (1 == d.length) {
          ...
          var i = d[0].length;
          i >= a && t.substr(0, d[0].length) == d[0] && t.substr(t.length - d[1].length) == d[1] && (a = i, n = o, r = t.substr(d[0].length, t.length - d[1].length - d[0].length));
        }
      }
      var s = e[n] || t;
      return "string" == typeof r && (s = s.replace("*", r)), s;
    }
    function i() {}
    function s() {
    ...
    function m(e) {
      ...
      if ("object" == typeof e || "function" == typeof e)
        if (P) {
          var r;
          for (var n in e)
            (r = Object.getOwnPropertyDescriptor(e, n)) && y(t, n, r);
        } else {
          var a = e && e.hasOwnProperty;
          for (var n in e)
            (!a || e.hasOwnProperty(n)) && (t[n] = e[n]);
        }
      return t["default"] = e, y(t, "__useDefault", {value: !0}), t;
    }
    function p() {
      return {
        name: null,
    ...
    var h = "undefined" == typeof window && "undefined" != typeof self && "undefined" != typeof importScripts,
    ...
    if ("undefined" != typeof document && document.getElementsByTagName) {
      if (b = document.baseURI, !b) {
        var x = document.getElementsByTagName("base");
        b = x[0] && x[0].href || window.location.href;
      }
      b = b.split("#")[0].split("?")[0], b = b.substr(0, b.lastIndexOf("/") + 1);
    } else if ("undefined" != typeof process && process.cwd)
      b = "file://" + (g ? "/" : "") + process.cwd() + "/", g && (b = b.replace(/\\/g, "/"));
    else {
      if ("undefined" == typeof location)
        throw new TypeError("No environment baseURI");
      b = e.location.href;
    }
    var E = e.URLPolyfill || e.URL;
    y(n.prototype, "toString", {value: function() {
        return "Module";
      }}), function() {
      function o(e) {
        return {
      ...
      function i(e, t, r, n) {
        return new Promise(function(a, o) {
          a(e.loaderObj.normalize(t, r, n));
        }).then(function(t) {
          var r;
          if (e.modules[t])
            return r = o(t), r.status = "linked", r.module = e.modules[t], r;
          for (var n = 0,
              a = e.loads.length; a > n; n++)
            if (r = e.loads[n], r.name == t)
              return r;
          return r = o(t), e.loads.push(r), s(e, r), r;
        });
      }
      function s(e, t) {
      ...
      function u(t, n, a) {
        a.then(function(a) {
          return "loading" == n.status ? Promise.resolve(t.loaderObj.translate({
            name: n.name,
            metadata: n.metadata,
            address: n.address,
            source: a
          })).then(function(e) {
            return n.source = e, t.loaderObj.instantiate({
              name: n.name,
              metadata: n.metadata,
              address: n.address,
              source: e
            ...
            if (void 0 === a)
              return n.address = n.address || "<Anonymous Module " + ++P + ">", n.isDeclarative = !0, k.call(t.loaderObj, n).then(function(t) {
                var a = e.System,
                    o = a.register;
                a.register = function(e, t, r) {
                  "string" != typeof e && (r = t, t = e), n.declare = r, n.depsList = t;
                }, r(t, n.address, {}), a.register = o;
              });
            if ("object" != typeof a)
              throw TypeError("Invalid instantiate return value");
            n.depsList = a.deps || [], n.execute = a.execute, n.isDeclarative = !1;
          }).then(function() {
            n.dependencies = [];
            for (var e = n.depsList,
                r = [],
                a = 0,
                o = e.length; o > a; a++)
              (function(e, a) {
                r.push(i(t, e, n.name, n.address).then(function(t) {
                  if (n.dependencies[a] = {
                    key: e,
                    value: t.name
                  }, "linked" != t.status)
                    for (var r = n.linkSets.concat([]),
                        o = 0,
                        d = r.length; d > o; o++)
                      m(r[o], t);
                }));
            ...
            n.status = "loaded";
            for (var e = n.linkSets.concat([]),
                t = 0,
                r = e.length; r > t; t++)
              h(e[t], n);
          }) : void 0;
        })["catch"](function(e) {
          n.status = "failed", n.exception = e;
          for (var t = n.linkSets.concat([]),
              r = 0,
              a = t.length; a > r; r++)
            v(t[r], n, e);
        });
      ...
      function c(e) {
        return function(t, r) {
          ...
          for (var i,
              c = 0,
              m = n.loads.length; m > c; c++)
            if (n.loads[c].name == a && (i = n.loads[c], "translate" != d || i.source || (i.address = e.moduleAddress, u(n, i, Promise.resolve(e.moduleSource))), i.linkSets.length))
          ...
          var h = f(n, p);
          n.loads.push(p), t(h.done), "locate" == d ? s(n, p) : "fetch" == d ? l(n, p, Promise.resolve(e.moduleAddress)) : (p.address = e.moduleAddress, u(n, p, Promise.resolve(e.moduleSource)));
        };
      }
      function f(e, t) {
        var r = {
      ...
      function v(e, r, n) {
          ...
          if (e.loads[0].name == r.name)
            ...
            for (var o = 0; o < e.loads.length; o++)
              for (var d = e.loads[o],
                ...
                if (s.value == r.name) {
                  n = t(n, "Error loading " + r.name + ' as "' + s.key + '" from ' + d.name);
                  break e;
                }
              }
        ...
        for (var l = e.loads.concat([]),
            ...
            u = l.length; u > o; o++) {
          var r = l[o];
          a.loaderObj.failed = a.loaderObj.failed || [], -1 == w.call(a.loaderObj.failed, r) && a.loaderObj.failed.push(r);
          var c = w.call(r.linkSets, e);
          if (r.linkSets.splice(c, 1), 0 == r.linkSets.length) {
            var f = w.call(e.loader.loads, r);
      ...
      function g(e, t) {
        ...
        var n = w.call(e.loads, t);
        -1 != n && e.loads.splice(n, 1);
        for (var a = 0,
            o = t.linkSets.length; o > a; a++)
          n = w.call(t.linkSets[a].loads, t), -1 != n && t.linkSets[a].loads.splice(n, 1);
      ...
      a.prototype = {
        ...
        "import": function(e, t, r) {
          ...
          return Promise.resolve(n.normalize(e, t)).then(function(e) {
            var t = n._loader;
            return t.modules[e] ? (_(t.modules[e], [], t._loader), t.modules[e].module) : t.importPromises[e] || x(n, e, d(t, e, {}).then(function(r) {
              return delete t.importPromises[e], S(t, r);
            }));
          });
        },
        load: function(e, t) {
          var r = this._loader;
          return r.modules[e] ? (_(r.modules[e], [], r), Promise.resolve(r.modules[e].module)) : r.importPromises[e] || x(this, e, d(r, e, {}).then(function(t) {
            return delete r.importPromises[e], S(r, t);
          }));
        },
        module: function(e, t) {
          var r = o();
          r.address = t && t.address;
          var n = f(this._loader, r),
              a = Promise.resolve(e),
              d = this._loader,
              i = n.done.then(function() {
                return S(d, r);
              });
          return u(d, r, a), i;
        },
    ...
    o.prototype.normalize = function(e, t, r) {
      return e = e.match(_) || "." == e[0] ? new E(e, t || b).href : new E(d(this.paths, e), b).href;
    }, o.prototype.locate = function(e) {
      return e.name;
    }, o.prototype.instantiate = function(t) {
      var n = this;
      return Promise.resolve(n.normalize(n.transpiler)).then(function(a) {
        return t.address === a ? {
          deps: [],
          execute: function() {
            var a = e.System,
                o = e.Reflect.Loader;
            return r("(function(require,exports,module){" + t.source + "})();", t.address, e), e.System = a, e.Reflect.Loader = o, n.newModule({
              "default": e[n.transpiler],
              __useDefault: !0
            });
          }
        } : void 0;
    ...
    !function() {
      ...
      function r(e, t) {
        return new Promise(function(e, r) {
          t.metadata.integrity && r(new Error("Subresource integrity checking is not supported in web workers.")), d = t;
          try {
            importScripts(t.address);
          } catch (n) {
            d = null, r(n);
          }
          d = null, t.metadata.entry || r(new Error(t.address + " did not call System.register or AMD define")), e("");
        });
      }
      ...
      u("pushRegister_", function(e) {
        return function(r) {
          return e.call(this, r) ? !1 : (d ? this.reduceRegister_(d, r) : i ? this.reduceRegister_(t(), r) : l ? c.push(r) : this.reduceRegister_(null, r), !0);
        };
      }), u("fetch", function(t) {
        return function(d) {
          var u = this;
          return d.metadata.scriptLoad && (v || h) ? h ? r(u, d) : new Promise(function(t, r) {
            function f(e) {
              if (!h.readyState || "loaded" == h.readyState || "complete" == h.readyState) {
                if (l--, d.metadata.entry || c.length) {
                  if (!i) {
                    for (var n = 0; n < c.length; n++)
                      u.reduceRegister_(d, c[n]);
                    c = [];
                  }
                } else
                  u.reduceRegister_(d);
                p(), d.metadata.entry || d.metadata.bundle || r(new Error(d.name + " did not call System.register or AMD define")), t("");
              }
            }
            function m(e) {
              p(), r(new Error("Unable to load script " + d.address));
            }
            function p() {
            ...
            h.async = !0, d.metadata.integrity && h.setAttribute("integrity", d.metadata.integrity), i ? (h.attachEvent("onreadystatechange", f), s.push({
              script: h,
              load: d
            })) : (h.addEventListener("load", f, !1), h.addEventListener("error", m, !1)), l++, a = e.System, h.src = d.address, n.appendChild(h);
          }) : t.call(this, d);
        };
      });
    }(), function() {
      function t(e, r, n) {
        if (n[e.groupIndex] = n[e.groupIndex] || [], -1 == w.call(n[e.groupIndex], e)) {
          ...
          for (var a = 0,
            ...
            if (i && !i.evaluated) {
              ...
              if (null === i.groupIndex || i.groupIndex < s) {
                if (null !== i.groupIndex && (n[i.groupIndex].splice(w.call(n[i.groupIndex], i), 1), 0 == n[i.groupIndex].length))
      ...
      function r(e, r) {
        ...
        if (!n.module) {
          ...
          var a = [];
          t(n, r, a);
          for (var d = !!n.declarative == a.length % 2,
              s = a.length - 1; s >= 0; s--) {
            for (var l = a[s],
                u = 0; u < l.length; u++) {
              var c = l[u];
        ...
        if (!t.module) {
          var n = r._loader.moduleRecords,
              ...
              s = t.declare.call(e, function(e, t) {
                if (d.locked = !0, "object" == typeof e)
                  ...
                  i[e] = t;
                for (var n = 0,
                    a = d.importers.length; a > n; n++) {
                  var o = d.importers[n];
                  if (!o.locked) {
                    var s = w.call(o.dependencies, d);
                    o.setters[s](i);
                  }
                }
                return d.locked = !1, t;
          ...
          for (var l = 0,
            ...
            var c,
                ...
                m = r.defined[f],
                p = n[f];
            p ? c = p.exports : m && !m.declarative ? c = m.esModule : m ? (o(m, r), p = m.module, c = p.exports) : c = r.get(f), p && p.importers ? (p.importers.push(d), d.dependencies.push(p)) : d.dependencies.push(null);
      ...
      function d(e, t) {
        var r,
            n = t.defined[e];
        if (n)
          n.declarative ? l(e, [], t) : n.evaluated || i(n, t), r = n.module.exports;
        else if (r = t.get(e), !r)
      ...
      function i(t, r) {
        if (!t.module) {
          ...
          c && (a.exports = c), n = a.exports, n && n.__esModule ? t.esModule = n : t.esmExports ? t.esModule = m(n) : t.esModule = {"default": n};
        }
      }
      function l(t, r, n) {
        var a = n.defined[t];
        if (a && !a.evaluated && a.declarative) {
          ...
          for (var o = 0,
            ...
            -1 == w.call(r, i) && (n.defined[i] ? l(i, r, n) : n.get(i));
          }
      ...
      s.prototype.register = function(e, t, r) {
        ...
        var n = p();
        n.name = e && (this.normalizeSync || this.normalize).call(this, e), n.declarative = !0, n.deps = t, n.declare = r, this.pushRegister_({
          amd: !1,
          entry: n
        });
      }, s.prototype.registerDynamic = function(e, t, r, n) {
        "string" != typeof e && (n = r, r = t, t = e, e = null);
        var a = p();
        a.name = e && (this.normalizeSync || this.normalize).call(this, e), a.deps = t, a.execute = n, a.executingRequire = r, this.pushRegister_({
          amd: !1,
          entry: a
        });
        ...
        return function(e, t) {
          if (t) {
            var r = t.entry,
                n = e && e.metadata;
            if (r.name && (r.name in this.defined || (this.defined[r.name] = r), n && (n.bundle = !0)), !r.name || e && r.name == e.name) {
              if (!n)
      ...
      u("fetch", function(e) {
        ...
        return function(e) {
          ...
          if (n.defined[e.name])
            ...
            if ("undefined" != typeof __exec && __exec.call(n, e), !e.metadata.entry && !e.metadata.bundle)
          ...
          t || (t = p(), t.deps = e.metadata.deps, t.execute = function() {}), n.defined[e.name] = t;
          var a = f(t.deps);
          t.deps = a.names, t.originalIndices = a.indices, t.name = e.name, t.esmExports = e.metadata.esmExports !== !1;
          for (var o = [],
              d = 0,
              i = t.deps.length; i > d; d++)
            o.push(Promise.resolve(n.normalize(t.deps[d], e.name)));
          return Promise.all(o).then(function(a) {
            return t.normalizedDeps = a, {
              deps: t.deps,
              execute: function() {
                return r(e.name, n), l(e.name, [], n), n.defined[e.name] = void 0, n.newModule(t.declarative ? t.module.exports : t.esModule);
              }
            };
          });
        };
    ...
    }), S = new s, S.version = "0.19.5 Register Only", "object" == typeof exports && (module.exports = a), e.Reflect = e.Reflect || {}, e.Reflect.Loader = e.Reflect.Loader || a, e.Reflect.global = e.Reflect.global || e, e.LoaderPolyfill = a, S || (S = new o, S.constructor = o), "object" == typeof exports && (module.exports = S), e.System = S;
