      ...
      !function(e) {
        ...
        M(r.prototype, "toString", {value: function() {
          ...
          a.prototype = {
            ...
            load: function(e, t) {
              var n = this._loader;
              return n.modules[e] ? (S(n.modules[e], [], n), Promise.resolve(n.modules[e].module)) : n.importPromises[e] || y(this, e, s(n, e, {}).then(function(t) {
        ...
        d("locate", function(e) {
          ...
          if ("warnings" in e && (this.warnings = e.warnings), e.baseURL) {
            ...
            this.baseURL = e.baseURL, b.call(this);
          }
          ...
          for (var v in e) {
            ...
            if ("baseURL" != v && "map" != v && "packages" != v && "bundles" != v && "paths" != v && "warnings" != v && "packageConfigPaths" != v)
              if ("object" != typeof a || a instanceof Array)
                ...
                this[v] = this[v] || {}, ("meta" == v || "depCache" == v) && (y = !0);
                for (var n in a)
                  "meta" == v && "*" == n[0] ? this[v][n] = a[n] : y ? this[v][this.normalizeSync(n)] = a[n] : this[v][n] = a[n];
              }
          }
        }, d("normalize", function(e) {
          return function(t, n) {
            var r = e.apply(this, arguments);
            return this.has(r) ? r : r.match($) ? (this.defaultJSExtensions && ".js" != r.substr(r.length - 3, 3) && (r += ".js"), r) : (r = s(this.paths, r) || r, this.defaultJSExtensions && ".js" != r.substr(r.length - 3, 3) && (r += ".js"), "." == r[0] || "/" == r[0] ? new L(r, H).href : new L(r, b.call(this)).href);
          };
        }), function() {
          function e(e) {
            var t,
          ...
          function s(r, a) {
            return function(s, l, d) {
              function c(t, n, r) {
                n = n || e.call(y, t);
                var r = r || n && y.packages[n];
                return r ? o.call(y, t, n, r, a, d) : t + (v ? ".js" : "");
              }
              if (d = d === !0, l)
              ...
              var v = this.defaultJSExtensions && ".js" != s.substr(s.length - 3, 3),
                  b = r.call(this, s, l);
              v && ".js" != b.substr(b.length - 3, 3) && (v = !1), v && (b = b.substr(0, b.length - 3)), f && "." == s[0] && b == f + "/" && (b = f);
              var y = this;
              if (a)
                return c(b);
              var w = e.call(this, b),
              ...
              if (x && x.configured)
                return c(b, w, x);
              var S = i(y, b);
              return S.pkgName ? Promise.resolve(_(y, b)).then(function(e) {
                if (e || m[S.pkgName]) {
                  var t = m[S.pkgName] = m[S.pkgName] || {
                    bundles: [],
                    promise: Promise.resolve()
                  };
                  return e && -1 == O.call(t.bundles, e) && (t.bundles.push(e), t.promise = Promise.all([t.promise, y.load(e)])), t.promise;
                }
              }).then(function() {
                return c(b, S.pkgName);
              }).then(function(e) {
                return e in y.defined ? e : u(y, S).then(function() {
                  return c(b);
                });
              }) : c(b, w, x);
            };
          ...
          function u(e, t) {
            ...
            return n && n.configured ? Promise.resolve() : b[t.pkgName] || (b[t.pkgName] = Promise.resolve().then(function() {
              for (var r = [],
          ...
          d("fetch", function(e) {
            ...
            return function(e) {
              ...
              t || (t = y(), t.deps = e.metadata.deps, t.execute = function() {}), r.defined[e.name] = t;
              var a = f(t.deps);
        ...
        d("reduceRegister_", function(t) {
          ...
          d("instantiate", function(a) {
            return function(s) {
              var i = this;
              if (s.metadata.format || (n.lastIndex = 0, r.lastIndex = 0, (r.exec(s.source) || n.exec(s.source)) && (s.metadata.format = "cjs")), "cjs" == s.metadata.format) {
                var l = s.metadata.deps,
                    u = t(s.source);
                for (var d in s.metadata.globals)
                  u.push(s.metadata.globals[d]);
                var c = y();
                s.metadata.entry = c, c.deps = u, c.executingRequire = !0, c.execute = function(t, n, r) {
                  for (var a = 0; a < l.length; a++)
                    t(l[a]);
                  var u = s.address || "",
                      d = u.split("/");
                  d.pop(), d = d.join("/"), "file:///" == u.substr(0, 8) ? (u = u.substr(7), d = d.substr(7), j && (u = u.substr(1), d = d.substr(1))) : o && u.substr(0, o.length) === o && (u = u.substr(o.length), d = d.substr(o.length));
                  var c = e.define;
                  ...
                  s.source = "(function(require, exports, module, __filename, __dirname, global, GLOBAL) {" + f + s.source + "\n}).apply(__cjsWrapper.exports, __cjsWrapper.args);", U.call(i, s), e.__cjsWrapper = void 0, e.define = c;
                };
              }
              return a.call(i, s);
            };
          ...
          d("normalize", function(t) {
            ...
            return function(t) {
              ...
              return t.metadata.loaderModule && t.metadata.loaderModule.instantiate ? Promise.resolve(t.metadata.loaderModule.instantiate.call(n, t)).then(function(r) {
                return t.metadata.entry = y(), t.metadata.entry.execute = function() {
                  return r;
        ...
        }(), F = new l, F.version = "0.19.5 Standard", "object" == typeof exports && (module.exports = a), e.Reflect = e.Reflect || {}, e.Reflect.Loader = e.Reflect.Loader || a, e.Reflect.global = e.Reflect.global || e, e.LoaderPolyfill = a, F || (F = new o, F.constructor = o), "object" == typeof exports && (module.exports = F), e.System = F;
