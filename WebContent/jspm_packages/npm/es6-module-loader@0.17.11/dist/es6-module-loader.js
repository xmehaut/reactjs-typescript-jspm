...
(function(process) {
  !function(a) {
    ...
    function h() {}
    var i = ("undefined" == typeof window && "undefined" != typeof self && "undefined" != typeof importScripts, "undefined" != typeof window && "undefined" != typeof document, "undefined" != typeof process && "undefined" != typeof process.platform && !!process.platform.match(/^win/));
    a.console || (a.console = {assert: function() {}});
    var j,
        k = Array.prototype.indexOf || function(a) {
          for (var b = 0,
              c = this.length; c > b; b++)
            if (this[b] === a)
              return b;
    ...
    if ("undefined" != typeof document && document.getElementsByTagName) {
      if (l = document.baseURI, !l) {
        var m = document.getElementsByTagName("base");
        l = m[0] && m[0].href || window.location.href;
      }
      l = l.split("#")[0].split("?")[0], l = l.substr(0, l.lastIndexOf("/") + 1);
    } else if ("undefined" != typeof process && process.cwd)
      l = "file://" + (i ? "/" : "") + process.cwd() + "/", i && (l = l.replace(/\\/g, "/"));
    else {
      if ("undefined" == typeof location)
        throw new TypeError("No environment baseURI");
      l = a.location.href;
    }
    var n = a.URLPolyfill || a.URL;
    j(d.prototype, "toString", {value: function() {
        return "Module";
      }}), function() {
      function f(a) {
        return {
      ...
      function i(a, b) {
        l(a, b, Promise.resolve().then(function() {
      ...
      function n(a) {
        return function(b, c) {
          ...
          for (var h,
              j = 0,
              k = d.loads.length; k > j; j++)
            if (d.loads[j].name == e && (h = d.loads[j], "translate" != g || h.source || (h.address = a.moduleAddress, m(d, h, Promise.resolve(a.moduleSource))), h.linkSets.length && h.linkSets[0].loads[0].name == h.name))
          ...
          var p = o(d, n);
          d.loads.push(n), b(p.done), "locate" == g ? i(d, n) : "fetch" == g ? l(d, n, Promise.resolve(a.moduleAddress)) : (n.address = a.moduleAddress, m(d, n, Promise.resolve(a.moduleSource)));
        };
      }
      function o(a, b) {
        var c = {
      ...
      function s(a, c, d) {
        ...
        for (var j = a.loads.concat([]),
            ...
            l = j.length; l > f; f++) {
          var c = j[f];
          e.loaderObj.failed = e.loaderObj.failed || [], -1 == k.call(e.loaderObj.failed, c) && e.loaderObj.failed.push(c);
          var m = k.call(c.linkSets, a);
          if (c.linkSets.splice(m, 1), 0 == c.linkSets.length) {
            var n = k.call(a.loader.loads, c);
      ...
      function t(a, b) {
        ...
        var d = k.call(a.loads, b);
        -1 != d && a.loads.splice(d, 1);
        for (var e = 0,
            f = b.linkSets.length; f > e; e++)
          d = k.call(b.linkSets[e].loads, b), -1 != d && b.linkSets[e].loads.splice(d, 1);
      ...
      e.prototype = {
        ...
        load: function(a) {
          var b = this._loader;
          return b.modules[a] ? Promise.resolve() : b.importPromises[a] || v(this, a, new Promise(n({
            step: "locate",
            loader: b,
            moduleName: a,
            moduleMetadata: {},
    ...
    f.prototype.normalize = function(a, b, c) {
      return a = a.match(p) || "." == a[0] ? new n(a, b || l).href : new n(g(this.paths, a) || a, l).href;
    ...
    if ("undefined" != typeof XMLHttpRequest)
      ...
      q = function(a, b, c, d) {
        ...
        return r = r || require('fs'), a = i ? a.replace(/\//g, "\\").substr(8) : a.substr(7), r.readFile(a, function(a, b) {
          if (a)
            return d(a);
          var e = b + "";
    ...
    f.prototype.fetch = function(a) {
      return new Promise(function(b, c) {
        q(a.address, void 0, b, c);
      });
    }, "object" == typeof exports && (module.exports = e), a.Reflect = a.Reflect || {}, a.Reflect.Loader = a.Reflect.Loader || e, a.Reflect.global = a.Reflect.global || a, a.LoaderPolyfill = e, o || (o = new f, o.constructor = f), "object" == typeof exports && (module.exports = o), a.System = o;
