  ...
  !function(a) {
    ...
    k(d.prototype, "toString", {value: function() {
      ...
      function n(a) {
        return function(b) {
          var c = a.loader,
              ...
              e = a.step;
          if (c.modules[d])
            throw new TypeError('"' + d + '" already exists in the module table');
          for (var g,
              h = 0,
              k = c.loads.length; k > h; h++)
            if (c.loads[h].name == d && (g = c.loads[h], "translate" != e || g.source || (g.address = a.moduleAddress, m(c, g, Promise.resolve(a.moduleSource))), g.linkSets.length))
              return g.linkSets[0].done.then(function() {
                b(g);
              });
          var l = g || f(d);
      ...
      e.prototype = {
        ...
        load: function(a) {
          var b = this._loader;
          return b.modules[a] ? (D(b.modules[a], [], b), Promise.resolve(b.modules[a].module)) : b.importPromises[a] || w(this, a, g(b, a, {}).then(function(c) {
            return delete b.importPromises[a], C(b, c);
          }));
        },
        module: function(a, b) {
    ...
    var p,
        q = function() {
          ...
          function g(a, b) {
            ...
            return c.target = c.target || b.ScriptTarget.ES5, void 0 === c.sourceMap && (c.sourceMap = !0), c.sourceMap && (c.inlineSourceMap = !0), c.module = b.ModuleKind.System, b.transpile(a.source, c, a.address);
          }
    ...
    if ("undefined" != typeof XMLHttpRequest)
      s = function(a, b, c, d) {
        ...
        h || "undefined" == typeof XDomainRequest || (g = new XDomainRequest, g.onload = e, g.onerror = f, g.ontimeout = f, g.onprogress = function() {}, g.timeout = 0, i = !0), g.onreadystatechange = function() {
          4 === g.readyState && (200 === g.status || 0 == g.status && g.responseText ? e() : f());
