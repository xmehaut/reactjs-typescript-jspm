...
var TimeDisplay = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement('div', _extends({}, other, {style: this.prepareStyles(styles.root)}), React.createElement('div', {style: this.prepareStyles(styles.box)}, React.createElement('div', {style: this.prepareStyles(styles.time)}, React.createElement('span', {
      style: this.prepareStyles(styles.hour),
      onTouchTap: this.props.onSelectHour
    }, hour), React.createElement('span', null, ':'), React.createElement('span', {
      style: this.prepareStyles(styles.minute),
      onTouchTap: this.props.onSelectMin
    }, min)), React.createElement('span', {key: "affix"}, this.props.affix.toUpperCase())));
  }
});
