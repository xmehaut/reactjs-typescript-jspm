  ...
  render: function render() {
    ...
    var newChildren = React.Children.map(this.props.children, function(currentChild) {
      ...
      switch (currentChild.type.displayName) {
        ...
        case 'RaisedButton':
        case 'FlatButton':
          return React.cloneElement(currentChild, {style: _this.mergeStyles(styles.button, currentChild.props.style)});
        case 'FontIcon':
          return React.cloneElement(currentChild, {
        ...
        case 'ToolbarTitle':
          return React.cloneElement(currentChild, {style: _this.mergeStyles(styles.span, currentChild.props.style)});
        default:
          return currentChild;
      }
    }, this);
