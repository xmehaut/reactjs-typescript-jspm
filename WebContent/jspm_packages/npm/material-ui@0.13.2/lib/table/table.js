...
var Table = React.createClass({
  ...
  render: function render() {
    ...
    try {
      for (var _iterator = children[Symbol.iterator](),
    ...
    if (fixedHeader) {
      headerTable = React.createElement('div', {className: 'mui-header-table'}, React.createElement('table', {
        className: className,
    ...
    if (tFoot !== undefined) {
      if (fixedFooter) {
        footerTable = React.createElement('div', {className: 'mui-footer-table'}, React.createElement('table', {
          className: className,
          style: mergedTableStyle
        }, tFoot));
      } else {
    ...
    return React.createElement('div', {
      ...
      style: this.prepareStyles(styles.tableWrapper)
    }, headerTable, React.createElement('div', {
      className: 'mui-body-table',
      style: this.prepareStyles(styles.bodyTable),
      ref: 'tableDiv'
