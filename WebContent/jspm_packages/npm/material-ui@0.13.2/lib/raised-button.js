...
var RaisedButton = React.createClass({
  ...
  getStyles: function getStyles() {
    ...
    var styles = {
      ...
      overlayWhenHovered: {backgroundColor: ColorManipulator.fade(this._getLabelColor(), amount)}
    };
    return styles;
  },
  render: function render() {
    ...
    if (label) {
      labelElement = React.createElement('span', {style: this.prepareStyles(styles.label, labelStyle)}, label);
    }
