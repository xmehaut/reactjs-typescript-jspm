...
var CalendarToolbar = React.createClass({
  ...
  render: function render() {
    ...
    }, React.createElement('div', {key: dateTimeFormatted}, dateTimeFormatted)), React.createElement(ToolbarGroup, {
      key: 0,
      float: 'left'
    ...
    }, nextButtonIcon)), React.createElement(ToolbarGroup, {
      key: 1,
      float: 'right'
    }, React.createElement(IconButton, {
      style: styles.button,
  ...
  _nextMonthTouchTap: function _nextMonthTouchTap() {
    if (this.props.onMonthChange && this.props.nextMonth)
      this.props.onMonthChange(1);
  }
});
