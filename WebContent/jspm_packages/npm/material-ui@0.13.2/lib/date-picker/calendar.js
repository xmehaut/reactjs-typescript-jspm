...
var Calendar = React.createClass({
  ...
  windowListeners: {'keydown': '_handleWindowKeyDown'},
  ...
  render: function render() {
    ...
    return React.createElement(ClearFix, {style: this.mergeStyles(styles.root)}, React.createElement(DateDisplay, {
      ...
      weekCount: weekCount
    }), this.state.displayMonthDay && React.createElement('div', {style: this.prepareStyles(styles.calendarContainer)}, React.createElement(CalendarToolbar, {
      DateTimeFormat: DateTimeFormat,
      locale: locale,
    ...
    }, React.createElement('li', {style: weekTitleDayStyle}, 'S'), React.createElement('li', {style: weekTitleDayStyle}, 'M'), React.createElement('li', {style: weekTitleDayStyle}, 'T'), React.createElement('li', {style: weekTitleDayStyle}, 'W'), React.createElement('li', {style: weekTitleDayStyle}, 'T'), React.createElement('li', {style: weekTitleDayStyle}, 'F'), React.createElement('li', {style: weekTitleDayStyle}, 'S')), React.createElement(SlideInTransitionGroup, {direction: this.state.transitionDirection}, React.createElement(CalendarMonth, {
    ...
    }))), !this.state.displayMonthDay && React.createElement('div', {style: this.prepareStyles(styles.yearContainer)}, this._yearSelector()));
  },
  ...
  _handleDayTouchTap: function _handleDayTouchTap(e, date) {
    ...
    if (this.props.onDayTouchTap)
      this.props.onDayTouchTap(e, date);
  },
