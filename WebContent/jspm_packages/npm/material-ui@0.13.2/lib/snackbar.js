...
var Snackbar = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement('div', _extends({}, others, {style: rootStyles}), React.createElement('div', {style: styles.body}, React.createElement('div', {style: contentStyle}, React.createElement('span', null, message), actionButton)));
  },
  show: function show() {
