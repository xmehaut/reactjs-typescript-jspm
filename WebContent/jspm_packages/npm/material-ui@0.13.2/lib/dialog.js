...
(function(process) {
  ...
  var TransitionItem = React.createClass({
    ...
    render: function render() {
      ...
      return React.createElement('div', _extends({}, other, {style: this.prepareStyles(this.state.style, style)}), this.props.children);
    }
  });
  var Dialog = React.createClass({
    ...
    getStyles: function getStyles() {
      ...
      return {
        ...
        paper: {background: this.state.muiTheme.rawTheme.palette.canvasColor},
    ...
    render: function render() {
      ...
      var title = undefined;
      if (this.props.title) {
        title = Object.prototype.toString.call(this.props.title) === '[object String]' ? React.createElement('h3', {style: this.prepareStyles(styles.title)}, this.props.title) : this.props.title;
      }
      return React.createElement('div', {
        ref: 'container',
        style: this.prepareStyles(styles.main)
      }, React.createElement(ReactTransitionGroup, {
        component: 'div',
        ref: 'dialogWindow'
      }, this.state.open && React.createElement(TransitionItem, {
      ...
      }, this.props.children), actions))), React.createElement(Overlay, {
        ref: 'dialogOverlay',
    ...
    _getActionsContainer: function _getActionsContainer(actions) {
      ...
      if (actions.length) {
        ...
        actionContainer = React.createElement('div', {style: this.prepareStyles(actionStyle)}, actionObjects);
      }
