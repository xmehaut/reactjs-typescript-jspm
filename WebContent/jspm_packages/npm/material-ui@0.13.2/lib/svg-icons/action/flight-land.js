...
var ActionFlightLand = React.createClass({
  ...
  render: function render() {
    return React.createElement(SvgIcon, this.props, React.createElement('defs', null, React.createElement('path', {
      id: 'a',
      d: 'M0 0h24v24H0V0z'
    })), React.createElement('defs', null, React.createElement('path', {
      id: 'c',
      d: 'M0 0h24v24H0V0z'
    })), React.createElement('clipPath', {id: 'b'}, React.createElement('use', {overflow: 'visible'})), React.createElement('clipPath', {
      id: 'd',
      'clip-path': 'url(#b)'
    }, React.createElement('use', {overflow: 'visible'})), React.createElement('path', {
