...
var DeviceBattery20 = React.createClass({
  ...
  render: function render() {
    return React.createElement(SvgIcon, this.props, React.createElement('path', {d: 'M7 17v3.67C7 21.4 7.6 22 8.33 22h7.33c.74 0 1.34-.6 1.34-1.33V17H7z'}), React.createElement('path', {
      'fill-opacity': '.3',
