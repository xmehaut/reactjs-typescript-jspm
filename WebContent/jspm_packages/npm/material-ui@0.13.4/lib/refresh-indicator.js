...
var RefreshIndicator = _react2['default'].createClass({
  ...
  render: function render() {
    ...
    return _react2['default'].createElement(Paper, {
      circle: true,
  ...
  _renderChildren: function _renderChildren() {
    ...
    if (this.props.status !== 'ready') {
      ...
      childrenCmp = _react2['default'].createElement('div', {
        ...
        ref: 'path',
        style: this.prepareStyles(circleStyle.style, {transition: Transitions.create('all', '1.5s', null, 'ease-in-out')})
      }, circleStyle.attr))));
    } else {
      var circleStyle = this._getCircleStyle(paperSize);
      ...
      childrenCmp = _react2['default'].createElement('svg', {
        ...
        viewBox: '0 0 ' + VIEWBOX_SIZE + ' ' + VIEWBOX_SIZE
      }, _react2['default'].createElement('circle', _extends({style: this.prepareStyles(circleStyle.style)}, circleStyle.attr)), _react2['default'].createElement('polygon', _extends({style: this.prepareStyles(polygonStyle.style)}, polygonStyle.attr)));
    }
    return childrenCmp;
  },
  ...
  _scalePath: function _scalePath(path, step) {
    if (this.props.status !== 'loading' || !this.isMounted())
      return;
