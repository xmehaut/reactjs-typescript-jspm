...
var LinearProgress = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement('div', _extends({}, other, {style: this.prepareStyles(styles.root, style)}), React.createElement('div', {style: this.prepareStyles(styles.bar)}, React.createElement('div', {
      ref: 'bar1',
      style: this.prepareStyles(styles.barFragment1)
