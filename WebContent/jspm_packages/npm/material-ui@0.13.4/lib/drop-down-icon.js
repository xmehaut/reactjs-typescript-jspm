...
(function(process) {
  ...
  var DropDownIcon = React.createClass({
    ...
    getDefaultProps: function getDefaultProps() {
      return {closeOnMenuItemTouchTap: true};
    },
    ...
    render: function render() {
      ...
      return React.createElement('div', _extends({}, other, {style: this.prepareStyles(styles.root, this.props.style)}), React.createElement('div', {onTouchTap: this._onControlClick}, React.createElement(FontIcon, {
        className: iconClassName,
        style: iconStyle
      }, this.props.iconLigature), this.props.children), React.createElement(Menu, {
        ref: 'menuItems',
        style: styles.menu,
        menuItems: menuItems,
