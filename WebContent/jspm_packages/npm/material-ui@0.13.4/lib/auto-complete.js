...
var AutoComplete = React.createClass({
  ...
  render: function render() {
    ...
    var menu = this.state.open && (this.state.searchText !== '' || showAllItems) && requestsList && requestsList.length > 0 ? React.createElement(Menu, _extends({}, menuProps, {
      ref: 'menu',
      key: 'dropDownMenu',
      animated: animated,
      autoWidth: false,
    ...
    return React.createElement('div', {
    ...
    }, React.createElement('div', {style: {width: '100%'}}, React.createElement(TextField, _extends({}, other, {
      ref: 'searchTextField',
      ...
      onBlur: function() {
        if (_this.focusOnInput && _this.state.open)
          _this.refs.searchTextField.focus();
      },
      onFocus: function() {
    ...
    }, textFieldProps))), React.createElement(ReactTransitionGroup, null, menu));
  },
