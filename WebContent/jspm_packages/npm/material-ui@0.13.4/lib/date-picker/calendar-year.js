...
var CalendarYear = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement('div', {style: styles}, years);
  },
  _getYears: function _getYears() {
    ...
    for (var year = minYear; year <= maxYear; year++) {
      ...
      if (!DateTime.isBetweenDates(dateCheck, this.props.minDate, this.props.maxDate))
        continue;
  ...
  _handleYearTouchTap: function _handleYearTouchTap(e, year) {
    if (this.props.onYearTouchTap)
      this.props.onYearTouchTap(e, year);
  }
});
