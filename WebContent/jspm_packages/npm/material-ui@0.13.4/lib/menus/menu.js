...
var Menu = React.createClass({
  ...
  render: function render() {
    ...
    var styles = {
      ...
      selectedMenuItem: {color: this.state.muiTheme.rawTheme.palette.accent1Color}
    };
    ...
    var newChildren = React.Children.map(children, function(child) {
      ...
      if (animated) {
        ...
        childrenContainerStyles = _this2.prepareStyles(styles.menuItemContainer, {transitionDelay: transitionDelay + 'ms'});
      }
      ...
      if (!childIsADivider && !childIsDisabled)
        menuItemIndex++;
      return animated ? React.createElement('div', {style: childrenContainerStyles}, clonedChild) : clonedChild;
    });
    return React.createElement('div', {
      ...
      style: styles.paper,
      zDepth: zDepth
    }, React.createElement(List, _extends({}, other, {
      ref: 'list',
  ...
  _getSelectedIndex: function _getSelectedIndex(props) {
    ...
    React.Children.forEach(children, function(child) {
      var childIsADivider = child.type.displayName === 'MenuDivider';
      if (_this4._isChildSelected(child, props))
