...
var GridTile = React.createClass({
  ...
  render: function render() {
    ...
    var titleBar = null;
    if (title) {
      titleBar = React.createElement('div', {style: this.prepareStyles(styles.titleBar)}, React.createElement('div', {style: this.prepareStyles(styles.titleWrap)}, React.createElement('div', {style: this.prepareStyles(styles.title)}, title), subtitle ? React.createElement('div', {style: this.prepareStyles(styles.subtitle)}, subtitle) : null), actionIcon ? React.createElement('div', {style: this.prepareStyles(styles.actionIcon)}, actionIcon) : null);
    }
    ...
    return React.createElement(RootTag, _extends({style: mergedRootStyles}, other), newChildren, titleBar);
  }
});
