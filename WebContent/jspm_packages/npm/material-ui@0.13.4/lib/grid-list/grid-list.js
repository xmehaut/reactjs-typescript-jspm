...
var GridList = React.createClass({
  ...
  render: function render() {
    ...
    var wrappedChildren = React.Children.map(children, function(currentChild) {
      ...
      return React.createElement('div', {style: _this.prepareStyles(itemStyle)}, currentChild);
    });
    return React.createElement('div', _extends({style: this.prepareStyles(mergedRootStyles)}, other), wrappedChildren);
  }
});
