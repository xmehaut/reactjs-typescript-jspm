...
var TableBody = React.createClass({
    ...
    return React.Children.map(this.props.children, function(child) {
      if (React.isValidElement(child)) {
        var _ret = (function() {
          ...
          return {v: React.cloneElement(child, _extends({}, props, handlers), children)};
        })();
  ...
  _createRowCheckboxColumn: function _createRowCheckboxColumn(rowProps) {
    ...
    return React.createElement(TableRowColumn, {
      key: key,
      columnNumber: 0,
      style: {width: 24}
    }, checkbox);
  ...
  _isRowSelected: function _isRowSelected(rowNumber) {
    ...
    for (var i = 0; i < this.state.selectedRows.length; i++) {
      ...
      if (typeof selection === 'object') {
        if (this._isValueInRange(rowNumber, selection))
          return true;
      } else {
  ...
  _processRowSelection: function _processRowSelection(e, rowNumber) {
    ...
    if (this.props.onRowSelection)
      this.props.onRowSelection(this._flattenRanges(selectedRows));
  },
  ...
  _onCellClick: function _onCellClick(e, rowNumber, columnNumber) {
    ...
    if (this.props.onCellClick)
      this.props.onCellClick(rowNumber, this._getColumnId(columnNumber));
  },
  _onCellHover: function _onCellHover(e, rowNumber, columnNumber) {
    if (this.props.onCellHover)
      this.props.onCellHover(rowNumber, this._getColumnId(columnNumber));
  ...
  _onCellHoverExit: function _onCellHoverExit(e, rowNumber, columnNumber) {
    if (this.props.onCellHoverExit)
      this.props.onCellHoverExit(rowNumber, this._getColumnId(columnNumber));
