...
var ClockButton = React.createClass({
  ...
  propTypes: {position: React.PropTypes.oneOf(['left', 'right'])},
  ...
  render: function render() {
    ...
    }), React.createElement('span', {style: this.prepareStyles(styles.select)}), React.createElement('span', {style: this.prepareStyles(styles.label)}, this.props.children));
  }
});
