  ...
  !function() {
    function e() {
      !function(e) {
        ...
        function m(e) {
          ...
          if ("object" == typeof e || "function" == typeof e)
            if (N) {
              var n;
              for (var r in e)
                (n = Object.getOwnPropertyDescriptor(e, r)) && T(t, r, n);
            } else {
              var a = e && e.hasOwnProperty;
              for (var r in e)
                (!a || e.hasOwnProperty(r)) && (t[r] = e[r]);
            }
          return t["default"] = e, T(t, "__useDefault", {value: !0}), t;
        }
        function p(e, t, n) {
          for (var r in t)
            n && r in e || (e[r] = t[r]);
        ...
        function b() {
          if (Z[this.baseURL])
            return Z[this.baseURL];
          "/" != this.baseURL[this.baseURL.length - 1] && (this.baseURL += "/");
          var e = new A(this.baseURL, L);
          return this.baseURL = e.href, Z[this.baseURL] = e;
        }
        function y(e, t) {
          var n,
              r = 0;
        ...
        function w(e) {
          if ("." != e[0] && "/" != e[0] && !e.match(X)) {
            var t = y(this.map, e);
            if (t)
              return this.map[t] + e.substr(t.length);
          }
          return e;
        }
        function S(e) {
        ...
        function k(e, t, n) {
          return this["import"](e.module, t).then(function(t) {
            if (e.prop ? t = v(e.prop, t) : "object" == typeof t && t + "" == "Module" && (t = t["default"]), n && "boolean" != typeof t)
              throw new TypeError("Condition " + _(e) + " did not resolve to a boolean.");
            return e.negate ? !t : t;
          });
        }
        function P(e, t) {
          ...
          var r = j(n[0].substr(2, n[0].length - 3));
          return this.builder ? this.normalize(r.module, t).then(function(t) {
            return r.module = t, e.replace(Q, "#{" + _(r) + "}");
        ...
        var M = "undefined" == typeof window && "undefined" != typeof self && "undefined" != typeof importScripts,
            O = "undefined" != typeof window && "undefined" != typeof document,
            z = "undefined" != typeof process && "undefined" != typeof process.platform && !!process.platform.match(/^win/);
        ...
        !function() {
          try {
            Object.defineProperty({}, "a", {}) && (T = Object.defineProperty);
          } catch (e) {
            T = function(e, t, n) {
              try {
        ...
        T(r.prototype, "toString", {value: function() {
            return "Module";
          }}), function() {
          function o(e) {
            return {
          ...
          function d(t, r, a) {
            a.then(function(a) {
              return "loading" == r.status ? Promise.resolve(t.loaderObj.translate({
                ...
                if (void 0 === a)
                  return r.address = r.address || "<Anonymous Module " + ++j + ">", r.isDeclarative = !0, E.call(t.loaderObj, r).then(function(t) {
                    var a = e.System,
                        o = a.register;
          ...
          function c(e) {
            return function(t, n) {
              ...
              for (var i,
                ...
                if (r.loads[c].name == a && (i = r.loads[c], "translate" != s || i.source || (i.address = e.moduleAddress, d(r, i, Promise.resolve(e.moduleSource))), i.linkSets.length && i.linkSets[0].loads[0].name == i.name))
          ...
          function g(e, n, r) {
            ...
            for (var u = e.loads.concat([]),
                ...
                d = u.length; d > o; o++) {
              var n = u[o];
              a.loaderObj.failed = a.loaderObj.failed || [], -1 == I.call(a.loaderObj.failed, n) && a.loaderObj.failed.push(n);
              var c = I.call(n.linkSets, e);
              if (n.linkSets.splice(c, 1), 0 == n.linkSets.length) {
                var f = I.call(e.loader.loads, n);
          ...
          function v(e, t) {
            ...
            var r = I.call(e.loads, t);
            -1 != r && e.loads.splice(r, 1);
            for (var a = 0,
                o = t.linkSets.length; o > a; a++)
              r = I.call(t.linkSets[a].loads, t), -1 != r && t.linkSets[a].loads.splice(r, 1);
          ...
          a.prototype = {
            ...
            "import": function(e, t, n) {
              ...
              return Promise.resolve(r.normalize(e, t)).then(function(e) {
                var t = r._loader;
                return t.modules[e] ? (S(t.modules[e], [], t._loader), t.modules[e].module) : t.importPromises[e] || y(r, e, s(t, e, {}).then(function(n) {
            ...
            load: function(e) {
              var t = this._loader;
              return t.modules[e] ? Promise.resolve() : t.importPromises[e] || y(this, e, new Promise(c({
                step: "locate",
                loader: t,
                moduleName: e,
                moduleMetadata: {},
        ...
        if ("undefined" != typeof XMLHttpRequest)
          ...
          J = function(e, t, n, r) {
            ...
            return C = C || require('fs'), e = z ? e.replace(/\//g, "\\").substr(8) : e.substr(7), C.readFile(e, function(e, t) {
              if (e)
                return r(e);
              var a = t + "";
        ...
        var B,
            H = ["main", "format", "defaultExtension", "meta", "map", "basePath", "depCache"];
        !function() {
          function n(e) {
          ...
          function o(e) {
            ...
            }, r(this, e), e.metadata.integrity && o.setAttribute("integrity", e.metadata.integrity), e.metadata.nonce && o.setAttribute("nonce", e.metadata.nonce), p.appendChild(o), p.removeChild(o), a(), window.onerror = i, s)
              throw s;
          }
          var s,
          ...
          var f = !1;
          if (O && "undefined" != typeof document && document.getElementsByTagName) {
        ...
        c(function(e) {
          return function() {
            e.call(this), this.baseURL = L.substr(0, L.lastIndexOf("/") + 1), this.map = {}, this.paths = {}, this.warnings = !1, this.defaultJSExtensions = !1, this.pluginFirst = !1, this.set("@empty", this.newModule({})), x.call(this, !1);
          };
        }), "undefined" == typeof require || "undefined" == typeof process || process.browser || (l.prototype._nodeRequire = require);
        var W = ["assert", "buffer", "child_process", "cluster", "console", "constants", "crypto", "dgram", "dns", "domain", "events", "fs", "http", "https", "module", "net", "os", "path", "process", "punycode", "querystring", "readline", "repl", "stream", "string_decoder", "sys", "timers", "tls", "tty", "url", "util", "vm", "zlib"];
        d("normalize", function(e) {
          return function(e, t, n) {
            if (e = w.call(this, e), "@node/" == e.substr(0, 6) && -1 != W.indexOf(e.substr(6))) {
            ...
            return ("." == e[0] || "/" == e[0]) && (e = t ? new A(e, t.replace(/#/g, "%05")).href.replace(/%05/g, "#") : new A(e, G).href), this.has(e) ? e : e.match(X) ? (this.defaultJSExtensions && ".js" != e.substr(e.length - 3, 3) && !n && (e += ".js"), e) : (e = s(this.paths, e) || e, this.defaultJSExtensions && ".js" != e.substr(e.length - 3, 3) && !n && (e += ".js"), "." == e[0] || "/" == e[0] ? new A(e, G).href : new A(e, b.call(this)).href);
          };
        });
        ...
        d("locate", function(e) {
          return function(t) {
            return Promise.resolve(e.call(this, t)).then(function(e) {
              return V ? e.replace(/#/g, "%23") : e;
            });
          };
        }), d("fetch", function() {
          return function(e) {
            return new Promise(function(t, n) {
              J(e.address, e.metadata.authorization, t, n);
            });
          };
        }), d("import", function(e) {
          ...
          if ("warnings" in e && (n.warnings = e.warnings), e.transpilerRuntime === !1 && (n._loader.loadedTranspilerRuntime = !0), e.baseURL) {
            ...
            n.baseURL = e.baseURL, b.call(n);
          }
          if (e.defaultJSExtensions && (n.defaultJSExtensions = e.defaultJSExtensions, g.call(n, "The defaultJSExtensions configuration option is deprecated, use packages configuration instead.")), e.pluginFirst && (n.pluginFirst = e.pluginFirst), e.production && x.call(n, !0), e.paths)
          ...
          if (e.map) {
            ...
            for (var r in e.map) {
              ...
              if ("string" != typeof o) {
                ...
                l && n.packages[l].main && (i = i.substr(0, i.length - n.packages[l].main.length - 1));
                var u = n.packages[i] = n.packages[i] || {};
                u.map = o;
              } else
                n.map[r] = o;
            }
          ...
          if (e.packageConfigPaths) {
            for (var d = [],
              ...
              s && ".js" == p.substr(p.length - 3, 3) && (p = p.substr(0, p.length - 3)), d[c] = p + f.substr(m);
            }
            ...
            for (var r in e.bundles) {
              for (var v = [],
                ...
                var s = n.defaultJSExtensions && ".js" != e.bundles[r][c].substr(e.bundles[r][c].length - 3, 3),
                    y = n.decanonicalize(e.bundles[r][c]);
                s && ".js" == y.substr(y.length - 3, 3) && (y = y.substr(0, y.length - 3)), v.push(y);
              }
              n.bundles[r] = v;
            }
          if (e.packages)
            for (var r in e.packages) {
              ...
              var s = n.defaultJSExtensions && ".js" != r.substr(r.length - 3, 3),
                  i = n.decanonicalize(w(r));
              s && ".js" == i.substr(i.length - 3, 3) && (i = i.substr(0, i.length - 3)), "/" == i[i.length - 1] && (i = i.substr(0, i.length - 1)), n.packages[i] = n.packages[i] || {}, e.packages[r].modules && (g.call(n, "Package " + r + ' is configured with "modules", which is deprecated as it has been renamed to "meta".'), e.packages[r].meta = e.packages[r].modules, delete e.packages[r].modules);
              for (var S in e.packages[r])
                -1 == I.call(H, S) && g.call(n, '"' + S + '" is not a valid package configuration option in package ' + r);
              h(n.packages[i], e.packages[r]);
            }
          for (var E in e) {
            var o = e[E];
            if ("baseURL" != E && "map" != E && "packages" != E && "bundles" != E && "paths" != E && "warnings" != E && "packageConfigPaths" != E)
              if ("object" != typeof o || o instanceof Array)
                ...
                for (var r in o)
                  if ("meta" == E && "*" == r[0])
                    ...
                    n[E][n.decanonicalize(w(r))] = o[r];
                  else if ("depCache" == E) {
                    var s = n.defaultJSExtensions && ".js" != r.substr(r.length - 3, 3),
                        i = n.decanonicalize(r);
                    s && ".js" == i.substr(i.length - 3, 3) && (i = i.substr(0, i.length - 3)), n[E][i] = o[r];
                  } else
                    n[E][r] = o[r];
              }
          }
          ...
          function n(e, t, n, r, a, o) {
            if (!a || "/" == a[a.length - 1] || o || t.defaultExtension === !1)
              return a;
            if (a.match(Q))
              return a;
            var s = !1;
            ...
            return a.substr(a.length - i.length) != i ? a + i : a;
          }
          function r(e, r, o, s, i) {
            if (!s) {
              if (!r.main)
                return o + (e.defaultJSExtensions ? ".js" : "");
              s = "./" == r.main.substr(0, 2) ? r.main.substr(2) : r.main;
            }
            var l = t(r);
            if (r.map) {
              var u = "./" + s,
                  d = y(r.map, u);
              if (d || (u = "./" + n(e, r, o, l, s, i), u != "./" + s && (d = y(r.map, u))), d)
                return a(e, r, o, l, d, u, i);
            }
            return o + "/" + l + n(e, r, o, l, s, i);
          }
          function a(e, t, r, a, o, s, i) {
            var l = t.map[o];
            if ("string" != typeof l && (l = o = s), "." == l)
              l = r;
            else if ("./" == l.substr(0, 2))
              return r + "/" + a + n(e, t, r, a, l.substr(2) + s.substr(o.length), i);
            return e.normalizeSync(l + s.substr(o.length), r + "/");
          }
          function o(e, r, a, o, s) {
            if (!o) {
              if (!r.main)
                return Promise.resolve(a + (e.defaultJSExtensions ? ".js" : ""));
              o = "./" == r.main.substr(0, 2) ? r.main.substr(2) : r.main;
            }
            var l,
                u,
                d = t(r);
            return r.map && (l = "./" + o, u = y(r.map, l), u || (l = "./" + n(e, r, a, d, o, s), l != "./" + o && (u = y(r.map, l)))), (u ? i(e, r, a, d, u, l, s) : Promise.resolve()).then(function(t) {
          ...
          function s(e, t, r, a, o, s, i, l) {
            if ("." == s)
              ...
              return Promise.resolve(r + "/" + a + n(e, t, r, a, s.substr(2) + i.substr(o.length), l)).then(function(t) {
                return P.call(e, t, r + "/");
              });
          ...
          function i(e, t, n, r, a, o, i) {
            var l = t.map[a];
            return "string" == typeof l ? s(e, t, n, r, a, l, o, i) : e.builder ? Promise.resolve(n + "/#:" + o) : e["import"](t.map["@env"] || "@system-env", n).then(function(e) {
              for (var t in l) {
                var n = "~" == t[0],
          ...
          function f(e, t) {
            for (var n,
              ...
              if (!(t.length < i.length)) {
                ...
                !l || n && (a && i.wildcard || !(n.length < l[1].length)) || (n = l[1], a = !i.wildcard, r = n + s.substr(i.length));
              }
            }
            return n ? {
              packageName: n,
          ...
          function m(e, n, r) {
            ...
            return (a.meta[r] = a.meta[r] || {}).format = "json", a.load(r).then(function() {
              ...
              for (var s in o)
                -1 == I.call(H, s) && delete o[s];
              var i = e.packages[n] = e.packages[n] || {};
              h(i, o, !0);
              var l = t(i);
              if (o.depCache) {
          ...
          c(function(e) {
            ...
            return function(n, r) {
              ...
              return void 0 == i && s && s.meta && p(s.meta, a.substr(o), function(e, t, n) {
            ...
            return function(o, s, i) {
              ...
              var l = this;
              if (i = i === !0, s)
                var u = e(l, s) || l.defaultJSExtensions && ".js" == s.substr(s.length - 3, 3) && e(l, s.substr(0, s.length - 3));
              var d = u && l.packages[u];
              if (d) {
                var c = t(d);
                c && s.substr(u.length + 1, c.length) == c && (s = u + s.substr(u.length + c.length));
              }
              if (d && "." != o[0]) {
                var m = d.map,
                    p = m && y(m, o);
                if (p && "string" == typeof m[p])
                  return a(l, d, u, t(d), p, o, i);
              }
              var h = l.defaultJSExtensions && ".js" != o.substr(o.length - 3, 3),
                  v = n.call(l, o, s);
              h && ".js" != v.substr(v.length - 3, 3) && (h = !1), h && (v = v.substr(0, v.length - 3));
              var b = f(l, v),
                  x = b && b.packageName || e(l, v);
              if (!x)
                return v + (h ? ".js" : "");
              var w = v.substr(x.length + 1);
              return r(l, l.packages[x] || {}, x, w, i);
            };
          }), d("normalize", function(n) {
            return function(r, a, s) {
              var l = this;
              return s = s === !0, Promise.resolve().then(function() {
                if (a)
                  var n = e(l, a) || l.defaultJSExtensions && ".js" == a.substr(a.length - 3, 3) && e(l, a.substr(0, a.length - 3));
                ...
                if (o && "./" != r.substr(0, 2)) {
                  var d = o.map,
                      c = d && y(d, r);
                  if (c)
                    return i(l, o, n, u, c, r, s);
                }
                return Promise.resolve();
              }).then(function(t) {
                if (t)
                  return t;
                var i = l.defaultJSExtensions && ".js" != r.substr(r.length - 3, 3),
                    u = n.call(l, r, a);
                i && ".js" != u.substr(u.length - 3, 3) && (i = !1), i && (u = u.substr(0, u.length - 3));
                var d = f(l, u),
                    c = d && d.packageName || e(l, u);
                if (!c)
                  return Promise.resolve(u + (i ? ".js" : ""));
                var p = l.packages[c],
                    h = p && (p.configured || !d);
            ...
            return function(r) {
              ...
              return Promise.resolve(n.call(this, r)).then(function(n) {
                ...
                if (o) {
                  ...
                  s.format && (r.metadata.format = r.metadata.format || s.format);
                  var u = {};
                  if (s.meta) {
                    var d = 0;
                    p(s.meta, l, function(e, t, n) {
                      n > d && (d = n), h(u, t, n && d > n);
          ...
          d("pushRegister_", function(e) {
            ...
            return function(s) {
              var d = this;
              return "json" != s.metadata.format && s.metadata.scriptLoad && (O || M) ? M ? n(d, s) : new Promise(function(t, n) {
                function f(e) {
                  if (!h.readyState || "loaded" == h.readyState || "complete" == h.readyState) {
                    if (u--, s.metadata.entry || c.length) {
                      ...
                      d.reduceRegister_(s);
                    p(), s.metadata.entry || s.metadata.bundle || n(new Error(s.name + " did not call System.register or AMD define. If loading a global module configure the global name via the meta exports property for script injection support.")), t("");
                  }
                }
                function m(e) {
        ...
        !function() {
          function t(e, n, r) {
            if (r[e.groupIndex] = r[e.groupIndex] || [], -1 == I.call(r[e.groupIndex], e)) {
              ...
              for (var a = 0,
                ...
                if (i && !i.evaluated) {
                  ...
                  if (null === i.groupIndex || i.groupIndex < l) {
                    if (null !== i.groupIndex && (r[i.groupIndex].splice(I.call(r[i.groupIndex], i), 1), 0 == r[i.groupIndex].length))
          ...
          function u(t, n, r) {
            ...
            if (a && !a.evaluated && a.declarative) {
              ...
              for (var o = 0,
                ...
                -1 == I.call(n, i) && (r.defined[i] ? u(i, n, r) : r.get(i));
              }
          ...
          l.prototype.register = function(e, t, n) {
            ...
            return function(t) {
              return t.metadata.deps = t.metadata.deps || [], Promise.resolve(e.call(this, t)).then(function(e) {
                return ("register" == t.metadata.format || !t.metadata.format && S(t.source)) && (t.metadata.format = "register"), e;
              });
            };
          }), d("instantiate", function(e) {
            return function(t) {
              ...
              if (a.defined[t.name])
                ...
                if ("undefined" != typeof B && B.call(a, t), !t.metadata.entry && !t.metadata.bundle)
                ...
                if ("esm" == o.metadata.format || "es6" == o.metadata.format || !o.metadata.format && s.transpiler !== !1 && a.match(t)) {
                  ...
                  return s._loader.loadedTranspiler = s._loader.loadedTranspiler || !1, s.pluginLoader && (s.pluginLoader._loader.loadedTranspiler = s._loader.loadedTranspiler || !1), (s._loader.transpilerPromise || (s._loader.transpilerPromise = Promise.resolve(e["typescript" == s.transpiler ? "ts" : s.transpiler] || (s.pluginLoader || s)["import"](s.transpiler)))).then(function(e) {
                    return s._loader.loadedTranspilerRuntime = !0, e.translate ? e == o.metadata.loaderModule ? o.source : ("string" == typeof o.metadata.sourceMap && (o.metadata.sourceMap = JSON.parse(o.metadata.sourceMap)), Promise.resolve(e.translate.call(s, o)).then(function(e) {
                      ...
                      return "esm" == o.metadata.format && !s.builder && S(e) && (o.metadata.format = "register"), e;
                    })) : (s.builder && (o.metadata.originalSource = o.source), U.call(s, o).then(function(e) {
        ...
        var Y = "undefined" != typeof self ? "self" : "global";
        d("fetch", function(e) {
          return function(t) {
          ...
          return function(n, r) {
            if (r || !n.metadata.exports)
              return t.call(this, n, r);
            n.metadata.format = "global";
            var a = n.metadata.entry = E();
          ...
          return function() {
            ...
            var o,
                ...
                i = ["_g", "sessionStorage", "localStorage", "clipboardData", "frames", "frameElement", "external", "mozAnimationStartTime", "webkitStorageInfo", "webkitIndexedDB", "mozInnerScreenY", "mozInnerScreenX"];
            ...
            return function(o) {
              ...
              if (o.metadata.format || (n.lastIndex = 0, r.lastIndex = 0, (r.exec(o.source) || n.exec(o.source)) && (o.metadata.format = "cjs")), "cjs" == o.metadata.format) {
                ...
                o.metadata.entry = d, d.deps = l, d.executingRequire = !0, d.execute = function(t, n, r) {
                  ...
                  var u = e.define;
                  e.define = void 0;
                  var d = s.get("@@cjs-helpers").getPathVars(r.id);
                  e.__cjsWrapper = {
                    exports: n,
                  ...
                  if (o.metadata.globals)
                    for (var f in o.metadata.globals)
                      c += "var " + f + ' = require("' + o.metadata.globals[f] + '");';
                  o.source = "(function(require, exports, module, __filename, __dirname, global, GLOBAL) {" + c + o.source + "\n}).apply(__cjsWrapper.exports, __cjsWrapper.args);", B.call(s, o), e.__cjsWrapper = void 0, e.define = u;
                };
              }
              return a.call(s, o);
            };
          ...
          return function() {
            var t = this;
            if (e.call(t), "undefined" != typeof window && "undefined" != typeof document && window.location)
              var n = location.protocol + "//" + location.hostname + (location.port ? ":" + location.port : "");
            t.set("@@cjs-helpers", t.newModule({getPathVars: function(e) {
                var t,
                    r = e.lastIndexOf("!");
                t = -1 != r ? e.substr(0, r) : e;
                var a = t.split("/");
                return a.pop(), a = a.join("/"), "file:///" == t.substr(0, 8) ? (t = t.substr(7), a = a.substr(7), z && (t = t.substr(1), a = a.substr(1))) : n && t.substr(0, n.length) === n && (t = t.substr(n.length), a = a.substr(n.length)), {
                  filename: t,
                  dirname: a
                };
              }}));
          ...
          return function() {
            ...
            function r(e, t, n, a) {
              ...
              if ("string" == typeof e && "function" == typeof t && (e = [e]), !(e instanceof Array)) {
                if ("string" == typeof e) {
                  var o = s.defaultJSExtensions && ".js" != e.substr(e.length - 3, 3),
                      i = s.decanonicalize(e, a);
                  o && ".js" == i.substr(i.length - 3, 3) && (i = i.substr(0, i.length - 3));
                  var l = s.get(i);
                  if (!l)
            ...
            function a(t, a, o) {
              ...
              var l,
                  u,
                  d;
              -1 != (l = I.call(a, "require")) && (a.splice(l, 1), t || (a = a.concat(n(o.toString(), l)))), -1 != (u = I.call(a, "exports")) && a.splice(u, 1), -1 != (d = I.call(a, "module")) && a.splice(d, 1);
              var c = E();
              c.name = t && (s.decanonicalize || s.normalize).call(s, t), c.deps = a, c.execute = i, s.pushRegister_({
                amd: !0,
                entry: c
              });
            }
          ...
          d("fetch", function(e) {
            return function(t) {
              return t.metadata.scriptLoad && O && this.get("@@amd-helpers").createDefine(), e.call(this, t);
            };
          ...
          d("decanonicalize", a), d("normalizeSync", a), d("normalize", function(a) {
            return function(o, s, i) {
              ...
              s = e(this, s);
              var u = t(l, o);
              return u ? Promise.all([l.normalize(u.argument, s, !0), l.normalize(u.plugin, s)]).then(function(e) {
            ...
            return function(t) {
              ...
              return t.metadata.loaderModule && t.metadata.loaderModule.instantiate && !n.builder && "defined" != t.metadata.format ? Promise.resolve(t.metadata.loaderModule.instantiate.call(n, t)).then(function(r) {
                return t.metadata.entry = E(), t.metadata.entry.execute = function() {
                  return r;
        ...
        d("normalize", function(e) {
          return function(t, n, r) {
            var a = this;
            return R.call(a, t, n).then(function(t) {
        ...
        }(), D = new l, e.SystemJS = D, D.version = "0.19.22 Standard", "object" == typeof exports && (module.exports = a), e.Reflect = e.Reflect || {}, e.Reflect.Loader = e.Reflect.Loader || a, e.Reflect.global = e.Reflect.global || e, e.LoaderPolyfill = a, D || (D = new o, D.constructor = o), "object" == typeof exports && (module.exports = D), e.System = D;
