  ...
  !function() {
    function e() {
      !function(e) {
        ...
        function m(e) {
          ...
          if ("object" == typeof e || "function" == typeof e)
            if (N) {
              var n;
              for (var r in e)
                (n = Object.getOwnPropertyDescriptor(e, r)) && I(t, r, n);
            } else {
              var a = e && e.hasOwnProperty;
              for (var r in e)
                (!a || e.hasOwnProperty(r)) && (t[r] = e[r]);
            }
          return t["default"] = e, I(t, "__useDefault", {value: !0}), t;
        }
        function p(e, t, n) {
          for (var r in t)
            n && r in e || (e[r] = t[r]);
        ...
        function b() {
          if (H[this.baseURL])
            return H[this.baseURL];
          "/" != this.baseURL[this.baseURL.length - 1] && (this.baseURL += "/");
          var e = new C(this.baseURL, T);
          return this.baseURL = e.href, H[this.baseURL] = e;
        }
        function y(e, t) {
          var n,
              r = 0;
        ...
        function P(e, t, n) {
          return this["import"](e.module, t).then(function(t) {
            if (e.prop ? t = v(e.prop, t) : "object" == typeof t && t + "" == "Module" && (t = t["default"]), n && "boolean" != typeof t)
              throw new TypeError("Condition " + j(e) + " did not resolve to a boolean.");
            return e.negate ? !t : t;
          });
        }
        function O(e, t) {
          ...
          var r = k(n[0].substr(2, n[0].length - 3));
          return this.builder ? this.normalize(r.module, t).then(function(t) {
            return r.module = t, e.replace(Z, "#{" + j(r) + "}");
          }) : P.call(this, r, t, !1).then(function(n) {
            if ("string" != typeof n)
        ...
        function R(e, t) {
          ...
          if (-1 == n)
            return Promise.resolve(e);
          var r = k(e.substr(n + 2));
          return this.builder ? this.normalize(r.module, t).then(function(t) {
            return r.module = t, e.substr(0, n) + "#?" + j(r);
          }) : P.call(this, r, t, !0).then(function(t) {
            return t ? e.substr(0, n) : "@empty";
          });
        }
        var _ = "undefined" == typeof window && "undefined" != typeof self && "undefined" != typeof importScripts,
            z = "undefined" != typeof window && "undefined" != typeof document,
            M = "undefined" != typeof process && "undefined" != typeof process.platform && !!process.platform.match(/^win/);
        ...
        !function() {
          try {
            Object.defineProperty({}, "a", {}) && (I = Object.defineProperty);
          } catch (e) {
            I = function(e, t, n) {
              try {
        ...
        if ("undefined" != typeof document && document.getElementsByTagName) {
          if (T = document.baseURI, !T) {
            var D = document.getElementsByTagName("base");
            T = D[0] && D[0].href || window.location.href;
          }
          T = T.split("#")[0].split("?")[0], T = T.substr(0, T.lastIndexOf("/") + 1);
        } else if ("undefined" != typeof process && process.cwd)
          T = "file://" + (M ? "/" : "") + process.cwd() + "/", M && (T = T.replace(/\\/g, "/"));
        else {
        ...
        I(r.prototype, "toString", {value: function() {
            return "Module";
          }}), function() {
          function o(e) {
            return {
          ...
          function g(e, n, r) {
            ...
            for (var u = e.loads.concat([]),
                ...
                d = u.length; d > o; o++) {
              var n = u[o];
              a.loaderObj.failed = a.loaderObj.failed || [], -1 == L.call(a.loaderObj.failed, n) && a.loaderObj.failed.push(n);
              var c = L.call(n.linkSets, e);
              if (n.linkSets.splice(c, 1), 0 == n.linkSets.length) {
                var f = L.call(e.loader.loads, n);
          ...
          function v(e, t) {
            ...
            var r = L.call(e.loads, t);
            -1 != r && e.loads.splice(r, 1);
            for (var a = 0,
                o = t.linkSets.length; o > a; a++)
              r = L.call(t.linkSets[a].loads, t), -1 != r && t.linkSets[a].loads.splice(r, 1);
        ...
        if ("undefined" != typeof XMLHttpRequest)
          ...
          q = function(e, t, n, r) {
            ...
            return U = U || require('fs'), e = M ? e.replace(/\//g, "\\").substr(8) : e.substr(7), U.readFile(e, function(e, t) {
              if (e)
                return r(e);
              var a = t + "";
        ...
        var $ = ["main", "format", "defaultExtension", "meta", "map", "basePath", "depCache"],
            B = /^[^\/]+:\/\//,
            H = {},
            X = new C(T);
        c(function(e) {
          return function() {
            e.call(this), this.baseURL = T.substr(0, T.lastIndexOf("/") + 1), this.map = {}, this.paths = {}, this.warnings = !1, this.defaultJSExtensions = !1, this.pluginFirst = !1, this.set("@empty", this.newModule({})), w.call(this, !1);
          };
        }), "undefined" == typeof require || "undefined" == typeof process || process.browser || (l.prototype._nodeRequire = require);
        var G = ["assert", "buffer", "child_process", "cluster", "console", "constants", "crypto", "dgram", "dns", "domain", "events", "fs", "http", "https", "module", "net", "os", "path", "process", "punycode", "querystring", "readline", "repl", "stream", "string_decoder", "sys", "timers", "tls", "tty", "url", "util", "vm", "zlib"];
        d("normalize", function(e) {
          return function(e, t, n) {
            if (e = x.call(this, e), "@node/" == e.substr(0, 6) && -1 != G.indexOf(e.substr(6))) {
            ...
            return ("." == e[0] || "/" == e[0]) && (e = t ? new C(e, t.replace(/#/g, "%05")).href.replace(/%05/g, "#") : new C(e, X).href), this.has(e) ? e : e.match(B) ? (this.defaultJSExtensions && ".js" != e.substr(e.length - 3, 3) && !n && (e += ".js"), e) : (e = s(this.paths, e) || e, this.defaultJSExtensions && ".js" != e.substr(e.length - 3, 3) && !n && (e += ".js"), "." == e[0] || "/" == e[0] ? new C(e, X).href : new C(e, b.call(this)).href);
          };
        });
        ...
        d("locate", function(e) {
          ...
          if (e.packages)
            for (var r in e.packages) {
              ...
              for (var S in e.packages[r])
                -1 == L.call($, S) && g.call(n, '"' + S + '" is not a valid package configuration option in package ' + r);
          ...
          c(function(e) {
            ...
            return function(o, s, i) {
              ...
              var b = f(l, v),
                  w = b && b.packageName || e(l, v);
              if (!w)
                return v + (h ? ".js" : "");
              var x = v.substr(w.length + 1);
              return r(l, l.packages[w] || {}, w, x, i);
            };
          ...
          d("pushRegister_", function(e) {
            ...
            return function(s) {
              var d = this;
              return "json" != s.metadata.format && s.metadata.scriptLoad && (z || _) ? _ ? n(d, s) : new Promise(function(t, n) {
                function f(e) {
        ...
        !function() {
          function t(e, n, r) {
            if (r[e.groupIndex] = r[e.groupIndex] || [], -1 == L.call(r[e.groupIndex], e)) {
              ...
              for (var a = 0,
                ...
                if (i && !i.evaluated) {
                  ...
                  if (null === i.groupIndex || i.groupIndex < l) {
                    if (null !== i.groupIndex && (r[i.groupIndex].splice(L.call(r[i.groupIndex], i), 1), 0 == r[i.groupIndex].length))
          ...
          function u(t, n, r) {
            ...
            if (a && !a.evaluated && a.declarative) {
              ...
              for (var o = 0,
                ...
                -1 == L.call(n, i) && (r.defined[i] ? u(i, n, r) : r.get(i));
              }
          ...
          return function() {
            ...
            t.set("@@cjs-helpers", t.newModule({getPathVars: function(e) {
                ...
                var a = t.split("/");
                return a.pop(), a = a.join("/"), "file:///" == t.substr(0, 8) ? (t = t.substr(7), a = a.substr(7), M && (t = t.substr(1), a = a.substr(1))) : n && t.substr(0, n.length) === n && (t = t.substr(n.length), a = a.substr(n.length)), {
                  filename: t,
                  dirname: a
                };
              }}));
          ...
          return function() {
            ...
            function a(t, a, o) {
              ...
              var l,
                  u,
                  d;
              -1 != (l = L.call(a, "require")) && (a.splice(l, 1), t || (a = a.concat(n(o.toString(), l)))), -1 != (u = L.call(a, "exports")) && a.splice(u, 1), -1 != (d = L.call(a, "module")) && a.splice(d, 1);
              var c = E();
        ...
        }), J = new l, e.SystemJS = J, J.version = "0.19.22 CSP", "object" == typeof exports && (module.exports = a), e.Reflect = e.Reflect || {}, e.Reflect.Loader = e.Reflect.Loader || a, e.Reflect.global = e.Reflect.global || e, e.LoaderPolyfill = a, J || (J = new o, J.constructor = o), "object" == typeof exports && (module.exports = J), e.System = J;
