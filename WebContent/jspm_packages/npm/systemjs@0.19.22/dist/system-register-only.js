...
(function(process) {
  !function(e) {
      ...
      function u(t, r, a) {
        a.then(function(a) {
          return "loading" == r.status ? Promise.resolve(t.loaderObj.translate({
            ...
            if (void 0 === a)
              return r.address = r.address || "<Anonymous Module " + ++P + ">", r.isDeclarative = !0, O.call(t.loaderObj, r).then(function(t) {
                var a = e.System,
                    o = a.register;
          ...
          if (e.loader.loaderObj.execute === !1) {
            for (var r = [].concat(e.loads),
              ...
              t.module = t.isDeclarative ? {
                ...
                module: j({}),
                evaluated: !0
              } : {module: j({})}, t.status = "linked", g(e.loader, t);
            }
            return e.resolve(n);
          }
          var i = p(e);
      ...
      u("pushRegister_", function(e) {
        ...
        return function(i) {
          ...
          return "json" != i.metadata.format && i.metadata.scriptLoad && (g || v) ? v ? n(u, i) : new Promise(function(t, n) {
            ...
            h.async = !0, i.metadata.integrity && h.setAttribute("integrity", i.metadata.integrity), d ? (h.attachEvent("onreadystatechange", f), s.push({
              script: h,
              load: i
    ...
    !function() {
      ...
      function n(e, n) {
        ...
        if (!r.module) {
          ...
          var a = [];
          t(r, n, a);
          for (var i = !!r.declarative == a.length % 2,
              s = a.length - 1; s >= 0; s--) {
            for (var l = a[s],
                u = 0; u < l.length; u++) {
              var c = l[u];
          ...
          var r = n._loader.moduleRecords,
              ...
              s = t.declare.call(e, function(e, t) {
                if (i.locked = !0, "object" == typeof e)
                  ...
                  d[e] = t;
                for (var r = 0,
                    a = i.importers.length; a > r; r++) {
                  var o = i.importers[r];
                  if (!o.locked) {
                    var s = w.call(o.dependencies, i);
                    o.setters[s](d);
                  }
                }
                return i.locked = !1, t;
              }, {id: t.name});
          if (i.setters = s.setters, i.execute = s.execute, !i.setters || !i.execute)
      ...
      function i(e, t) {
        var n,
            r = t.defined[e];
        if (r)
          r.declarative ? l(e, [], t) : r.evaluated || d(r, t), n = r.module.exports;
        else if (n = t.get(e), !n)
      ...
      function l(t, n, r) {
        ...
        if (a && !a.evaluated && a.declarative) {
          ...
          for (var o = 0,
            ...
            -1 == w.call(n, d) && (r.defined[d] ? l(d, n, r) : r.get(d));
          }
        ...
        return function(t) {
          ...
          return Promise.all(i).then(function(e) {
            return r.normalizedDeps = e, {
              deps: r.deps,
              execute: function() {
                return n(t.name, a), l(t.name, [], a), a.defined[t.name] = void 0, a.newModule(r.declarative ? r.module.exports : r.esModule);
              }
            };
          });
        };
    ...
    }), _ = new s, e.SystemJS = _, _.version = "0.19.22 Register Only", "object" == typeof exports && (module.exports = a), e.Reflect = e.Reflect || {}, e.Reflect.Loader = e.Reflect.Loader || a, e.Reflect.global = e.Reflect.global || e, e.LoaderPolyfill = a, _ || (_ = new o, _.constructor = o), "object" == typeof exports && (module.exports = _), e.System = _;
